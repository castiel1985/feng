...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'篇文章','prev'=>'上一页','next'=>'下一页','first'=>'首页','last'=>'尾页','theme'=>'%upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end% <a> %totalRow% %header% %nowPage%/%totalPage% 页</a>');
    // 默认分页变量名
    protected $varPage;
    /**
     * 架构函数
