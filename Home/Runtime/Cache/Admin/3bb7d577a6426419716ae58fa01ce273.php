...
<div class="login-wrapper">
    <div class="text-center">
        <h2 class="fadeInUp animation-delay8" style="font-weight:bold">
            <span class="text-success">Limpid</span> <span style="color:#ccc; text-shadow:0 1px #fff">管理后台</span>
        </h2>
    </div>
    <div class="login-widget animation-delay1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-login" action="/Admin/Adminuser/login.html" method="POST">
                    <div class="form-group">
                        <label>用户名</label>
                        <input type="text" name="user" placeholder="请输入后台管理用户名"
                    ...
                    <?php if(!empty($errmsg)): ?><div class="seperator"></div>
                        <div class="alert alert-danger">
                            <strong> <?php echo ($errmsg); ?></strong>
                        </div><?php endif; ?>
                    <hr/>
                    <button class="btn btn-success btn-sm bounceIn animation-delay5 login-link pull-right"
                            type="submit"><i class="fa fa-sign-in"></i> 登陆
                    </button>
                </form>
            </div>
        </div>
