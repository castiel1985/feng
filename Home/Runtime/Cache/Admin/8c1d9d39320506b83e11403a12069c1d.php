        ...
        <div class="padding-md">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="formToggleLine" class="form-horizontal no-margin form-border" action="/Admin/Diseases/addcategoryitem" method="post">
                        <div class="form-group">
                            <label class="col-lg-2 control-label">疾病分类项目名称</label>
                            <div class="col-lg-6">
                                <input class="form-control" type="text" placeholder="请输入疾病分类名称"  data-required="true"  name="name" id="name" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">适用物种类型</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <a href="<?php echo U('diseases/categorymgr');?>" type="reset" class="btn btn-danger">取消</a>
                            </div>
                        </div>
                    </form>
                </div>
